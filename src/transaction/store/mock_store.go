...
func (_m *MockStore) GetTransactionByID(ctx context.Context, id string) (*domain.Transaction, error) {
...
func (_m *MockStore) Insert(ctx context.Context, transaction *domain.Transaction) (*domain.Transaction, error) {
